...
<body>
    <header style="
    height:100vh;
    background-image: linear-gradient(to top, rgba(161, 140, 209, 0.411) 0%, rgba(251, 194, 235, 0.404) 100%),url(<?= $imagen?>);
...
" id="inicio">
        <div class="contenedor head">
            <h1  style="color: #ffffff;" class="titulo"><?= $nombre ?></h1>
            <p  style="color: #ffffff;" class="copy">Have fun with our activities!!</p>
        </div>
    </header>
    <main>
        <section class="contenedor" id="servicio">
            ...
            <div class="contenedor-servicio">
                <div class="video">
                    <iframe width="560" height="315" src=<?= $urlYoutube ?> title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
