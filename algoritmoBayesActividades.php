...
require_once("conexion.php");
    ...
    if (isset($_POST['recomendacion'])) {
      ...
      $consulta_N_montaña = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'M'");
      $consulta_NC_precio_montaña = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'M' AND precio = $precio");
      $consulta_NC_tipoTurista_montaña = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'M' AND tipo_turista = $tipoTurista");
      $consulta_NC_tipoClima_montaña = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'M' AND tipo_clima = $tipoClima");
      $consulta_NC_señalInternet_montaña = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'M' AND internet = $señalInternet");
      $consulta_NC_lugar_montaña = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'M' AND provincia = $lugar");

      $consulta_N_playa = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'P'");
      $consulta_NC_precio_playa = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'P' AND precio = $precio");
      $consulta_NC_tipoTurista_playa = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'P' AND tipo_turista = $tipoTurista");
      $consulta_NC_tipoClima_playa = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'P' AND  tipo_clima = $tipoClima");
      $consulta_NC_señalInternet_playa = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'P' AND internet = $señalInternet");
      $consulta_NC_lugar_playa = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'P' AND provincia = $lugar");

      $consulta_N_ciudad = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'C'");
      $consulta_NC_precio_ciudad = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'C' AND precio = $precio");
      $consulta_NC_tipoTurista_ciudad = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'C' AND tipo_turista=$tipoTurista");
      $consulta_NC_tipoClima_ciudad = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'C' AND tipo_clima = $tipoClima");
      $consulta_NC_señalInternet_ciudad = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'C' AND internet = $señalInternet");
      $consulta_NC_lugar_ciudad = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad WHERE tipo_actividad = 'C' AND provincia = $lugar");
      ...
      $consulta_total_registros = mysqli_query($conexion, "SELECT COUNT(id) as total FROM Actividad");
      ...
      $consulta = mysqli_query($conexion, "SELECT * FROM Actividad WHERE tipo_actividad = '$mayor'");
      while($row = mysqli_fetch_array($consulta)){
        $arrayDatos[] = $row;
      }
      
    }else{
      $consulta = mysqli_query($conexion, "SELECT * FROM Actividad");
      while($row = mysqli_fetch_array($consulta)){
        $arrayDatos[] = $row;
      }
    }
