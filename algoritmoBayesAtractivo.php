...
require_once("conexion.php");
    ...
    if (isset($_POST['atractivo'])) {
      ...
      $consulta = mysqli_query($conexion, "SELECT * FROM atractivo_Turistico WHERE tipo_actividad = '$mayor'");
      while($row = mysqli_fetch_array($consulta)){
        $arrayDatos[] = $row;
      }
      
    }else{
      $consulta = mysqli_query($conexion, "SELECT * FROM atractivo_Turistico");
      while($row = mysqli_fetch_array($consulta)){
        $arrayDatos[] = $row;
      }
    }
